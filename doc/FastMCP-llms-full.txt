...
super().get\_routes() and extending the returned list.
...
* Optional protected resource routes if resource\_server\_url is configured
...
# registry
Source: https://gofastmcp.com/python-sdk/fastmcp-server-auth-registry
